...
const EditTodo = ({todo}) => {
    ...
    const updateDescription= async (e) =>{
        ...
        //used to refresh page to see update
            window.location ="/"
    ...
    return (
        <Fragment>
            <div class="container">
                <button type="button" class="btn btn-warning" data-toggle="modal" data-target={`#id${todo.todo_id}`} onClick={()=> setDescription(todo.description)}>Edit</button>
                <div class="modal fade" id={`id${todo.todo_id}`} role="dialog">
